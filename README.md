...
3. From project dir,
   ...
   npx expo start
   ```
   Now just press A to open on Android. It should automatically open your emulator or if you have an android device connected and emulator should give you an option. 
